...
import pbs
from frac_simulation import FracSimulation
...
class Process(base_process.Process):
    ...
    def setup_config(self, n_levels, clean):
        ...
        FracSimulation.total_sim_id = 0

        self.options['output_dir'] = output_dir
        mlmc_obj = mlmc.MLMC(n_levels, FracSimulation.factory(self.step_range, config=simulation_config, clean=clean),
